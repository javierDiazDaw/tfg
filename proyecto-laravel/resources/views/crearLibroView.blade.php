...
@section('content')
    ...
    <div class="col-12 table-responsive fondoBlanco letraPequeña ps-5 pe-5 ms-1 mt-5">
        <form class="form-register" action="/libros/crear" method="post" enctype="multipart/form-data">
            <div class="row mb-5">
                <div class="col">
                ...
                <div class="col">
                    <label for="exampleFormControlInput2" class="form-label fw-bold ">Estado</label>
                    <input type="text" class="form-control" aria-label="estado">
                </div>
            </div>
            <div class="row mb-5">
                <div class="col">
                    <label for="exampleFormControlInput3" class="form-label fw-bold ">Descripción</label>
                    <input type="text" class="form-control" aria-label="descripcion">
                </div>
            </div>
            <div class="row mb-5">
                <div class="col">
                    <label for="exampleFormControlInput4" class="form-label fw-bold ">Fecha de creación</label>
                    <input type="date" class="form-control" aria-label="fechaCreacion">
                </div>
                <div class="col">
                    <label for="exampleFormControlInput5" class="form-label fw-bold ">Fecha de modificación</label>
                    <input type="date" class="form-control" aria-label="fechaModificacion">
                </div>
                <div class="col">
                    <label for="exampleFormControlInput6" class="form-label fw-bold ">Fecha de cierre</label>
